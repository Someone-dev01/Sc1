...
if (!isNumber(user.lastngroket)) user.lastngroket = 0
if (!isNumber(user.lastngtaxy)) user.lastngtaxy = 0
if (!isNumber(user.lastMonsterBattle)) user.lastMonsterBattle = 0 
if (!isNumber(user.lastrob)) user.lastrob = 0
...
antiPorn: false
 ...
 let akinator = global.db.data.users[m.sender].akinator
            ...
            if (
            !m.fromMe &&
            !global.db.data.users[m.sender].moderator &&
            opts["self"]
        )
        return;
...
text: `Access Bots In The Group
Link: https://chat.whatsapp.com/E8ygCxuUO2u96BivGKAxRu

Catatan:
- Bot hanya akan merespon di dalam group, kecuali untuk user premium.
- masuk ke dalam group jika ingin menggunakan bot secara geratis

- Anda dapat meng -upgrade menjadi user premium jika ingin menggunakan bot di private chat. (Pesan pribadi)

- Berikut harga list upgrade premium user

- Rp 2.000 : 1 minggu
- Rp 3.500 : 2 minggu 
- Rp 5.000 : 1 bulan
- Rp 20.000 : tanpa batas

- Hubungi owner wa.me/6285727485224
`,
contextInfo: {
mentionedJid: [m.sender, nomorown],
externalAdReply: { showAdAttribution: false, 
title: 'Bot Access To Private Chat Denied!',
sourceUrl: sig,
thumbnailUrl: 'https://telegra.ph/file/8cd3f1a4dcf824e0b1dbc.jpg',
mediaType: 1,
...
text: `🚩 Maaf Limitmu Sudah Habis Silahkan Beli Premium / beli limit dengan cara, Ketik *.buylimit*`,
contextInfo: {
externalAdReply: { showAdAttribution: true, 
title: `Maaf, limit anda telah habis!!`,
thumbnailUrl: 'https://telegra.ph/file/6930dd4aaab4e1c8efb77.jpg',
mediaType: 1,
renderLargerThumbnail: true 
}}}, { quoted: m})
...
let pp = 'https://telegra.ph/file/69b07c8b2f7912b9e6ee2.jpg'
let ppgc = 'https://telegra.ph/file/69b07c8b2f7912b9e6ee2.jpg'
...
let imgr = 'https://telegra.ph/file/8cd3f1a4dcf824e0b1dbc.jpg'
let msg = {
rowner: '\n~-----~ _*`Access Denied`*_ ~-----~\n🔒 _Sorry, this command can only be used by the owner._',
owner: '\n~-----~ _*`Access Denied`*_ ~-----~\n🔒 _Sorry, this command can only be used by the owner._',
mods: '\n~-----~ _*`Access Denied`*_ ~-----~\n🔒_Only mods_',
premium: '\n~-----~ _*`Access Denied`*_ ~-----~\n🔒 _Sorry, this command is only for premium users._\n_*.buypremium*_',
group: '\n~-----~ _*`Access Denied`*_ ~-----~\n🔒 _Sorry, this command can only be used in the group._',
vip: '\n~-----~ _*`Access Denied`*_ ~-----~\n🔒 _Sorry, this command is only for VIP users._',
private: '\n~-----~ _*`Access Denied`*_ ~-----~\n🔒 _Sorry, this command can only be used in private chat._',
admin: '\n~-----~ _*`Access Denied`*_ ~-----~\n🔒 _Sorry, this command is only for the group admin._',
botAdmin: '\n~-----~ _*`Access Denied`*_ ~-----~\n_🔒 Make the bot admin to use this command._',
restrict: '\n~-----~ _*Access Denied*_ ~-----~\n_🔒 This feature is disabled._',
}[type]
...
externalAdReply: {
title: namebot,
body: "Your Access Is Denied❗",
thumbnailUrl: imgr,
mediaType: 1,
renderLargerThumbnail: true
}}}, { quoted: m})
let msgg = {
unreg: `🚩 Hello *@${m.sender.split("@")[0]}* silahkan daftar ke *database* bot terlebih dahulu jika ingin menggunakan fitur bot.\n\n> *example:*\n.register Kazuma.18\n\n> *auto example:*\n.daftar\n\n> *auto example2:*\n@verify\n\n*email example:*\n.reg emailmu@gmail.com`
}[type]
...
externalAdReply: {
title: namebot,
body: 'Ketik #caradaftar untuk bantuan!',
thumbnailUrl: imgr,
mentionedJid: [m.sender], 
mediaType: 1,
renderLargerThumbnail: true
