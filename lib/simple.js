...
/*exports.smsg = (conn, m, hasParent) => {
     ...
     */
        ...
        conn.reply(chatId ? chatId : m.chat, text, m, { contextInfo: { mentionedJid: conn.parseMention(text), externalAdReply: { title: namebot, body: await conn.msToDate(process.uptime() * 1000), mediaType: 1, previewType: 0,renderLargerThumbnail: false, sourceUrl: scg, thumbnail: data }}, options })
    }
    m.name = m.pushName || conn.getName(m.sender)
