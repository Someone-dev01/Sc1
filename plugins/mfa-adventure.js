...
let afriza = async (m, { conn, usedPrefix, owner }) => {
    try {
        ...
        if (global.db.data.users[m.sender].health > 79) {
            if (new Date - user.lastadventure > 600000) {
                ...
                setTimeout(() => {
                    let result = `\nPetualanganmu telah berakhir di *${location}* dan kamu mendapatkan:
                    ...
                    conn.sendMessage(m.chat, {
                        ...
                        contextInfo: {
                            externalAdReply: { showAdAttribution: true,
                                title: 'Adventure',
                                body: '',
                                thumbnailUrl: 'https://telegra.ph/file/e76f1709120c8c5913047.jpg',
                                sourceUrl: gcbot,
                                mediaType: 1,
...
afriza.help = ['adventure'];
afriza.tags = ['rpg'];
afriza.command = /^(adventure|berpetualang|adv)$/i;
afriza.limit = true;
afriza.group = false;
afriza.fail = null;
