...
const Sbabi = 9000
const Sayam = 9000
let afriza  = async (m, { conn, command, args, usedPrefix, DevMode }) => {
        ...
        if (/pasar|toko/i.test(command)) {
           ...
           /* case 'buy':
            ...
            case 'jual': 
                ...
                break
            default:
                return conn.sendFile(m.chat, thumb, 'https://telegra.ph/file/4277cb1ec9c0fe3aa8c56.jpg', `${Kchat}`, m)
            }
...
afriza.help = ['pasar <jual> <args>']
afriza.tags = ['rpg']
    
afriza.command = /^(pasar|jual)$/i
