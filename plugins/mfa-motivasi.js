let handler = async (m, { conn, usedPrefix, command }) => {
    let thumb = 'https://telegra.ph/file/be4540fcd5490e51c56f2.jpg'
    await conn.sendFile(m.chat, thumb, 'motivasi.jpg', `${pickRandom(global.motivasi)}`, m)
    
}
handler.help = ['motivasi']
handler.tags = ['quotes']
handler.command = /^(motiv|motivasi)$/i
...
"Aksi tanpa bukti hanyalah cerita fiksi"
]