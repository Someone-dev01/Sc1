let handler = async (m, { conn, args, usedPrefix, command }) => {
    if (!(args[0] || args[1])) throw `Example: ${usedPrefix + command} 1 2 maka hasilnya adalah surah Al-Fatihah ayat 2`
    if (isNaN(args[0]) || isNaN(args[1])) throw `Example: ${usedPrefix + command} 1 2 maka hasilnya adalah surah Al-Fatihah ayat 2 `
