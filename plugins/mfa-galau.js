let handler = async (m, { conn, usedPrefix, command }) => {
    let thumb = 'https://telegra.ph/file/0deea5bde057a28b9dd63.jpg'
...
global.galau = [
   ...
   "Kamu memang sosok yg tak terduga Mudah membuat ku bahagia,mudah membuatku hancur saat itu juga.\n\n*BY PUTRI*",
    ...
    "Tak perlu membalas dengan menyakiti biar Karma yang akan urus semua itu",
    "Aku masih ingat kamu tapi perasaanku sudah tidak sakit seperti dulu",
    "Bukan hidupmu yang berat, tapi sholatmu yang sering telat, teruslah bersujud sampai mimpimu terwujud\nBY Rizz Sahaja",
    "Mahalul qiyam lebih menenangkan dari pada harapan dia yang menyakitkan\n*BY Rizz Sahaja*",
