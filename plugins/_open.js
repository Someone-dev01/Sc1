let afriza = async (m, { conn, command, args, text, usedPrefix }) => {
let lastUsage = global.db.data.users[m.sender].lastUsage || 0;
let elapsed = new Date - lastUsage;
let cooldown = 30000; // cooldown 10 detik

if (elapsed < cooldown) {
    let s = Math.floor((cooldown - elapsed) / 1000);
    return conn.reply(m.chat, `Tunggu *${s}* detik lagi sebelum menggunakan perintah ini!`, m);
}

global.db.data.users[m.sender].lastUsage = new Date * 1;
  try {
    let bruh = `${usedPrefix}open <crate name> < 1 | 2 | 3 | 4 >\n\nContoh penggunaan: *${usedPrefix}open common 1*\n\nlist crate:\n*common*\n*uncommon*\n*mythic*\n*legendary*`
    let _lmao = args[0]
    let Lmao = `Hanya support 1, 2, 3, 4\nContoh penggunaan: *${usedPrefix}open ${args > 2 ? _lmao : pickRandom(['common', 'uncommon', 'mythic', 'legendary'])} 1*`
...
`.trim()
                ...
                case '3':
                    ...
                    let _ce2 = `${Math.floor(Math.random() * 6000)}`.trim()
...
`.trim()
                    ...
                    break
                case '4':
                    let _cm3 = `${Math.floor(Math.random() * 200)}`.trim()
                    let _cc3 = `${Math.floor(Math.random() * 350)}`.trim()
                    let _cp3 = `${Math.floor(Math.random() * 100)}`.trim()
                    let _ce3 = `${Math.floor(Math.random() * 400)}`.trim()
...
`.trim()
                ...
                case '3':
                    ...
                    let _ue2 = `${Math.floor(Math.random() * 4000)}`.trim()
...
`.trim()
                ...
                case '4':
                    ...
                    let _ue3 = `${Math.floor(Math.random() * 4000)}`.trim()
                    let _um3 = `${Math.floor(Math.random() * 5000)}`.trim()
...
`.trim()
                    ...
                    break
                case '3':
                    let _mm2 = `${Math.floor(Math.random() * 2000)}`.trim()
                    let _mmm2 = `${Math.floor(Math.random() * 10)}`.trim()
                    let _me2 = `${Math.floor(Math.random() * 4000)}`.trim()
...
`.trim()
                ...
                case '4':
                    ...
                    let _me3 = `${Math.floor(Math.random() * 200)}`.trim()
                    let _mp3 = `${Math.floor(Math.random() * 70)}`.trim()
                    let _mu3 = `${Math.floor(Math.random() * 250)}`.trim()
                    let _mc3 = `${Math.floor(Math.random() * 260)}`.trim()
...
`.trim()
        ...
        case 'legendary':
            switch (jumlah) {
                case '1':
                case 'crate':
                    let _lm = `${Math.floor(Math.random() * 200)}`.trim()
                    let _le = `${Math.floor(Math.random() * 30)}`.trim()
...
`.trim()  
                    ...
                    break
                case '2':
                    let _lm1 = `${Math.floor(Math.random() * 500)}`.trim()
                    let _le1 = `${Math.floor(Math.random() * 400)}`.trim()
...
`.trim()  
                    ...
                    break
                case '3':
                    let _lm2 = `${Math.floor(Math.random() * 800)}`.trim()
                    let _le2 = `${Math.floor(Math.random() * 600)}`.trim()
...
`.trim()  
                    ...
                    break
                case '4':
                    let _lm3 = `${Math.floor(Math.random() * 3000)}`.trim()
                    let _le3 = `${Math.floor(Math.random() * 5000)}`.trim()
...
`.trim()  
      ...
      console.log(e)
      conn.reply(m.chat, `${usedPrefix}open <crate name> < 1 | 2 | 3 | 4 >\n\nContoh penggunaan: *${usedPrefix}open common 1*\n\nlist crate:\n*common*\n*uncommon*\n*mythic*\n*legendary*`, m)
      if (DevMode) {
...
afriza.help = ['open <crate>', 'gacha <crate>']
afriza.tags = ['rpg']
afriza.command = /^(open|buka|gacha)$/i
