...
let afriza = async (m, { conn, args, text, usedPrefix, command, isROwner }) => {
    let _p = usedPrefix
    const linkgc = `${global.sgc}`
    const domain = 'https://panel.kaxel-host.tech'
    const apikey = 'ptla_DJ0LADh7nRBTQX9IEYn70iesx7G9LE25cUnImN16sZS';
    const c_apikey = 'ptlc_CATGItrBl5nJMNl3GTiLoqwo9TXLM4S16QdT6XxwZnL'
    switch (command) {
        case 'addusr': {
...
afriza.help = ['addusr', 'delusr', 'listusr', 'detusr', 'addsrv', 'delsrv', 'listsrv', 'detsrv', 'reinstall', 'updatesrv', 'startsrv', 'stopsrv', 'restartsrv'];
afriza.command = ['addusr', 'delusr', 'listusr', 'detusr', 'addsrv', 'delsrv', 'listsrv', 'detsrv', 'reinstall', 'updatesrv', 'startsrv', 'stopsrv', 'restartsrv'];
